...
function ImageCarousel() {
   return (
     ...
     >
       ...
       <div>
         <img src={landing5bkg} alt='bakg5' style={{width: '100%', maxHeight: '95vh', objectFit: 'cover'}}/>
       </div>
       <div>
         <img src={landing6bkg} alt='bakg6' style={{width: '100%', maxHeight: '95vh', objectFit: 'cover'}}/>
       </div>
       <div>
         <img src={landing7bkg} alt='bakg7' style={{width: '100%', maxHeight: '95vh', objectFit: 'cover'}}/>
       </div>
     </Carousel>
   );
 }
