				...
				<Grid item container xs={12} className={s.data}>
					...
					<Grid item container xs={11} sx={{display: "flex", justifyContent: 'flex-end', alignItems: 'center', height: '90%'}}>
						<Grid item lg={5} md={11} xs={11} sx={{display: "flex", flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'flex-start', padding: '25px', zIndex: 10}}>
							<h3 style={{margin: 0, fontSize: '2.5rem', color: '#EEEEEE', marginBottom: '20px'}}>Maderas Misiones</h3>
							<p style={{margin: 0, fontSize: '1.2rem',marginBottom: '10px', fontWeight: 400, color: '#EEEEEE', textAlign: 'justify'}}>Somos una empresa dedicada a la distribución y comercialización de productos para mobiliario, interiorismo y construcción. Consultanos por los materiales que necesitás para tu proyecto.</p>
							<Grid >
								<Link href='#contact'>
						...
						<Grid item lg={6} md={11} xs={11} sx={{display: "flex", flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', padding: '10px', zIndex: 10}}>
							<iframe width="90%" height="435px" src="https://www.youtube.com/embed/hdlM-Sm6MLs" title="Maderas Misiones Egger Haus" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
						</Grid>
					</Grid>
				</Grid>
			</Grid>
