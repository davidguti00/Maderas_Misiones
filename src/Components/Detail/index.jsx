            ...
            <Grid xs={12} md={10} lg={10} item container className={s.boxModal} sx={{ bgcolor: dark ? "#222222" : "#EEEEEE" }}>
               <Grid container item xs={12} sx={{display: "flex", justifyContent: "center"}}>
                  <Grid item container xs={12} md={12} lg={12} sx={{p: 2}}>
                     <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', height: '8%', alignItems: 'center', px: 1}}>
                     ...
                     <Grid item container xs={12}>
                        <Grid item xs={6} sx={{display: 'flex', justifyContent: 'center', alignItems: 'center', height: '50vh'}}>
                           <img src={data.image} alt={data.topic} width='100%' height='90%' style={{objectFit: 'cover', borderRadius: '5px'}}/>
                        </Grid>
                        <Grid item container xs={6} sx={{justifyContent: 'flex-start', alignItems: 'flex-start', height: '100%', p: 2}}>
                           ...
                           <Grid item xs={12} sx={{height: '72%', pt: 2}}>
